...
import Entity (Entity, creationIndex, cTypes)
import Matcher (allOfSet, just)
import Collection (Collection, initWithMatcher, addEntity, getMatcher)
import qualified Collection as Collection
