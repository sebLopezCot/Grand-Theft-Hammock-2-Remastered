...
hasComponentsOfType :: Entity -> Set String -> Bool
hasComponentsOfType entity cTypesIn = Set.isSubsetOf cTypesIn $ cTypes entity
...
addComponent entity component = 
    if hasComponentOfType entity $ cType component then entity else
        (entity{components = Map.insert (cType component) component $ components entity,
            cTypes = Set.insert (cTypes component) $ cTypes entity})
